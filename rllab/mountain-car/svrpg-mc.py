...
if __name__ == '__main__':
	...
	f_update_SVRG = theano.function(
		...
		outputs = None,
		updates = adam([eval_grad1, eval_grad2, eval_grad3, eval_grad4], params,
						learning_rate = learning_rate, beta1 = 0.90, beta2 = 0.95)
	)
	f_train_SVRG = theano.function(
		inputs=[observations_var, actions_var, d_rewards_var,
					eval_grad1, eval_grad2, eval_grad3, eval_grad4, importance_weights_var],
		outputs=grad_SVRG,
	)
	...
	name = filenameGenerateSVRG("svrg-beta9099-beta9095-64hn", discount, N, M, s_tot, m_itr, learning_rate)
