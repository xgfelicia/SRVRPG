...
def filenameGenerateSVRG(base, gamma, fg, lr):
	args = {"--gamma": gamma,
			"--fg-size": fg,
			"--learning-rate": lr,
			}
...
if __name__ == '__main__':
	...
	eval_grad3 = TT.matrix('eval_grad3',dtype=grad[2].dtype)	   # (8, 1) output.w = LI.GlorotUniform(),
	...
	name = filenameGenerateSVRG("gpomdp-beta90999-8x8hn", discount, N, learning_rate)
